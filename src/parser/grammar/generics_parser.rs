use crate::{
    lexer::Symbol,
    parser::{
        NameType, Node, ParseResult, TokenStream, TypeParameterNode, grammar::comma_separated_list,
    },
};

pub fn type_parameter_list(tokens: &mut TokenStream) -> ParseResult<Vec<Node<TypeParameterNode>>> {
    comma_separated_list(tokens, Symbol::CloseBracket, type_parameter)
}
